...
# ---------------------------------------------------------------------------
# Data loading (from cached JSON file, generated by fetch_data.py)
# ---------------------------------------------------------------------------
...
def load_from_json(year):
    ...
    playoff_teams = set(raw['playoff_teams'])
    season_data = {}
    ...
    return season_data, playoff_teams


data_file = f'data_{YEAR}.json'
if not os.path.exists(data_file):
    print(f"No cached data. Run first: python fetch_data.py {YEAR}")
    sys.exit(1)

print(f"Loading {YEAR} season from {data_file}...")
season_data, PLAYOFF_TEAMS = load_from_json(YEAR)
...
app.title = f"{YEAR} MLB Season Tracker"
...
app.layout = html.Div(className='app-container', children=[
    ...
    html.Div(className='header', children=[
        ...
        html.H1([html.Em(str(YEAR)), ' Win Rates Over Time'], className='title'),
        html.P(
            f'Every team\'s win percentage, game by game across the full {YEAR} season.',
            className='subtitle'
        ),
    ]),
    ...
    html.Div(className='footer', children=[
        ...
        html.Span(f'{YEAR} REGULAR SEASON  /  162 GAMES', className='footer-text'),
    ]),
])
...
def update_chart(filter_mode, style):
    ...
    if filter_mode == 'playoffs':
        teams = [t for t in PLAYOFF_TEAMS if t in season_data]
